...
describe('All the javascript should match', function () {
    ...
    it('the js code should contain an assignment line allow you create element div', function () {
    ...
    it('the js code should contain an assignment line allow you insert Hello Worl with innerHTML', function () {
    ...
    it('the js code should contain an assignment line allow you change background color into yellow', function () {
    ...
    it('the js code should contain an assignment line allow you add div into body', function () {
